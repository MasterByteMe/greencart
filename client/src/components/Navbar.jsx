...
const Navbar = () => {
    ...
    useEffect(() => {
        // Check if the search field has any text
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full">
                    <input onChange={(e) => setSearchQuery(e.target.value)}
                        ...
                        autoComplete="off"
                    />
                    <img src={assets.search_icon} alt="search_icon" className='w-5 h-4' />
                </div>

                {/* Desktop Menu- cartlogo */}
                ...
                {!user ? (<button onClick={() => setShowUserLogin(true)} className="cursor-pointer px-8 py-2 bg-primary hover:bg-primary-dull transition text-white rounded-full">
                    ...
                    <div className="relative group">
                        ...
                        <img src={assets.profile_icon} className="w-10" alt="prof_icon" />
                        <ul className="group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 py-2.5 w-30 rounded-md text-sm z-40">
